...
function getDir() {
    ...
    $.ajax({
        type: 'GET',
        url: '/admin/catalog/data/images/dirdata',
        data: {
            dir: js_dir,
        ...
        success: function (data) {
            ...
            $.each(data.files, function (key, val) {
                var pic;
                var act = '';
                pic = '/files/images_catalog/' + current_dir + '/.' + val.hash + '.jpg';
                var fp = 'blank.gif';
                var hp = '';
                if (val.fmt == 'j') {
...
uploader = new plupload.Uploader({
    ...
    url: '/admin/catalog/data/images/upload',
...
$('#btn_delete').click(function () {
    ...
    if (confirm(js_lang_delete_confirm + "\n\n" + list)) {
        $.ajax({
            type: 'POST',
            url: "/admin/catalog/data/images/delete",
            data: {
                dir: js_dir,
                data: names
            },
...
$('#btn_id_save').click(function () {
    ...
    if (id_mode == 'rename') {
        ...
        $.ajax({
            type: 'POST',
            url: "/admin/catalog/data/images/rename",
            data: {
                dir: js_dir,
